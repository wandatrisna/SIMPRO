											...
											<table class="table table-hover">
												...
												<tbody>
													...
													<tr>
														<td>
															<div class="task-contain">
																<p class="d-inline-block m-l-20"><strong>Plan st
																		Date</strong></p>
															</div>
														</td>
														<td>
													...
													<tr>
														<td>
															<div class="task-contain">
																<p class="d-inline-block m-l-20"><strong>Actual st
																		Date</strong>
																</p>
															</div>
														</td>
															...
															<div class="form-group row">
																...
																<div class="col-sm-9">
																	<input type="number" name="bobotsit"
																		class="form-control" id="bobotsit" value="10"
																		readonly>
															...
															<div class="form-group row">
																...
																<div class="col-sm-9">
																	<input type="number" name="progressit"
																		...
																		id="progressit" placeholder="Masukkan progres">
															...
															<div class="form-group row">
																...
																<?php echo $project1['filesit']; ?>
																	<input type="file" name="filesit"
																		class="form-control form-control-user"
																		value="<?php echo $project1['filesit']; ?>" id="file"
