                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card shadow mb-4">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a class="d-inline-block m-r-20"
                                                                            href="<?php echo base_url('assets/dokumenuat/' . $project1['fileuat']); ?>"><?= $project1['fileuat'] ?></a>
                                                ...
                                                <form
                                                    action="<?php echo base_url('Project/edituat/'). $project1['id_project'];?>"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="number" name="bobotuat"
                                                                                class="form-control" id="bobotuat"
                                                                                value="10" readonly>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            ...
                                                                            <input type="file" name="fileuat"
                                                                                class="form-control form-control-user"
                                                                                value="<?php echo $project1['fileuat']; ?>"
