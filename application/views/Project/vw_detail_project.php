										...
										<table class="table table-hover">
											<tbody>
												...
												<tr>
													<td>
														<div class="task-contain">
															<p class="d-inline-block m-l-20"><strong>Plan</strong></p>
														</div>
													</td>
													<td>
														<p class="d-inline-block m-r-20"><?= $project1['plan'] ?></p>
														<div class="progress d-inline-block">
												...
												<tr>
													<td>
														<div class="task-contain">
															<p class="d-inline-block m-l-20"><strong>Actual</strong></p>
														</div>
													</td>
													<td>
														<p class="d-inline-block m-r-20"><?= $project1['actual'] ?></p>
														<div class="progress d-inline-block">
												...
												<tr>
													<td>
														<div class="task-contain">
															<p class="d-inline-block m-l-20"><strong>Target</strong></p>
														</div>
													</td>
													<td>
														<p class="d-inline-block m-r-20"><?= $project1['target'] ?></p>
														<div class="progress d-inline-block">
															<div class="progress-bar bg-c-blue" role="progressbar"
																aria-valuemin="0" aria-valuemax="100" style="width:50%">
															</div>
												...
												<tr>
													<td>
														<div class="task-contain">
															<p class="d-inline-block m-l-20"><strong>Keterangan</strong>
															</p>
														</div>
													</td>
													<td>
														<p class="d-inline-block m-r-20"><?= $project1['keterangan'] ?>
														</p>
														<div class="progress d-inline-block">
															<div class="progress-bar bg-c-blue" role="progressbar"
																aria-valuemin="0" aria-valuemax="100" style="width:50%">
											...
											<div class="modal-dialog modal-lg" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div class="form-group row">
															<label class="col-sm-3 col-form-label">Jenis Project</label>
															<div class="col-sm-9">
														...
														<div class="form-group row">
															...
															<div class="col-sm-9">
																...
																<input type="file" name="urf"
																	class="form-control form-control-user"
																	value="<?php echo $project1['urf']; ?>" id="file"
