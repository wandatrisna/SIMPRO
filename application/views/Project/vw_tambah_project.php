										...
										<div class="col-sm-12">
											<div class="card" style="background-color: #ffffff;">
												<div class="card-header">
													<h4 class="title"><strong>Tambah Data Proyek</strong></h4><br>
													...
													<div class="card-block">
														<form action="" method="POST" enctype="multipart/form-data">
															...
															<div class="form-group row">
																<label class="col-sm-2 col-form-label">Dokumen URF</label>
																<div class="col-sm-10">
																	<input type="file" name="urf"
																		value="<?= set_value('urf'); ?>"
																		class="form-control form-control-user" id="urf"
																		placeholder="Insert File">
                                                                        <h6><font color="red">Dokumen URF Harus Diunggah!</font><br></h6>
