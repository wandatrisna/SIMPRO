                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><strong>&emsp;Planning
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-8 col-form-label">
                                            <td> :
                                                ...
                                                <a href="$eksternal['note_eks'];" class="badge badge-warning"
                                                    style="pointer-events: none">On Progress</a>

                                                <?php } else  if ($eksternal['note_eks'] == 'Done')  { ?>
                                                <a href="$eksternal['note_eks'];" class="badge badge-success"
                                                    style="pointer-events: none">Done</a>
                                                <?php } else  if ($eksternal['note_eks'] == Null)  { ?>
                                                <a href="$eksternal['note_eks'];" class="badge badge-secondary"
                                                    style="pointer-events: none">Null</a>
                                                <?php  }?>
                                            </td>
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><strong>&emsp;Migration
                                                Note</strong></label>
                                        <br>
                                        <label class="col-sm-8 col-form-label">
