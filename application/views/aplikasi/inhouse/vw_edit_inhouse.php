                    ...
                    <div class="card-block">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="hidden" name="jenisaplikasi" value="<?= $inhouse['jenisaplikasi']; ?>">
                                ...
                                <input type="hidden" name="tgl_penyerahan_pmf"
                                    value="<?= $inhouse['tgl_penyerahan_pmf']; ?>">
                                <input type="hidden" name="tgl_migrasi_prod"
                                    value="<?= $inhouse['tgl_migrasi_prod']; ?>">
