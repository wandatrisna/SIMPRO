						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<div class="chart-pie pt-4 pb-2">
									...
									<canvas id="myChart" width="560" height="260"
										style="display: block; height: 208px; width: 448px;"
...
<script>
	...
	let Paplikasi = <?= $Paplikasi ?>;
	let Pdokumen = <?= $Pdokumen ?>;
	let Pproject = <?= $Pproject ?>;
	let Peks = <?= $Peks ?>;
	let Pdivisi = <?= $Pdivisi ?>;
	new Chart(ctx, {
		type: 'pie',
		data: {
			labels: ['Parameter Aplikasi', 'Parameter Divisi', 'Parameter Dokumen', 'Parameter Eksternal', 'Parameter Proyek'],
			datasets: [{
				label: '',
				data: [Paplikasi, Pdivisi, Pdokumen, Peks, Pproject],
				borderWidth: 1
			}]
		},
		options: {
