                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form action="<?= base_url('Auth'); ?>" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="NIK"
                                                value="<?= set_value('NIK'); ?>" id="NIK" placeholder="NIK">
                                            <?= form_error('NIK', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                value="<?= set_value('password'); ?>" name="password" id="password"
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('Password') ?>">Klik disini untuk mengatur ulang kata sandi</a>
                                    </div>
                                </div>
                            </div>
                        </div>
