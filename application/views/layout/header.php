    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#B62327;">
            ...
            <li class="nav-item <?= $this->uri->segment(2) == 'indexpmf' || $this->uri->segment(2) == 'indexapp' ||
                ...
                <div id="collapsePages1" class="collapse <?= $this->uri->segment(2) == 'indexdok' || $this->uri->segment(2) == 'indexeks' || $this->uri->segment(2) == 'indexapp' ||
            ...
            <li class="nav-item <?= in_array($this->uri->segment(2), ['index', 'tambahproject']) ? ' active' : '' ?>">
            ...
            <li class="nav-item <?= in_array($this->uri->segment(2), [
                'indexlistproject', 'indexhistory', 'detail', 'detailhistory', 'editproject', 'hapusproject', 'detailbrd', 'detailfsd', 'detaildev', 
                'subdev', 'editbrd', 'editfsd', 'detailsit', 'editsit', 'detailuat', 'edituat', 'detailmigrasi', 'editmigrasi'
            ]) ? ' active' : '' ?>">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages1"
                    aria-expanded="true" aria-controls="collapsePages">
